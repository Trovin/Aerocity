...
function devvn_ihotspot_get_input_point_default($data = array()){
	...
	$pointLocation				= isset($data['location'])?$data['location']:'';
	$airport				    = isset($data['airport'])?$data['airport']:'';
	$pointLocation2				= isset($data['location2'])?$data['location2']:'';
	$aircrafts			        = isset($data['aircrafts'])?$data['aircrafts']:'';
	 	...
	 	<div class="devvn-hotspot-popup-inner">
			<div class="devvn-hotspot-popup-modal-content">
				<div class="devvn-hotspot-popup-modal-header">
					<h3 class="modal-title">Location Type (training)</h3>
			  	</div>
		  		<div class="devvn-hotspot-popup-modal-body">
                    ...
                    <h3 class="modal-title"> Main Title (Angel City Flyers)</h3>
					<?php
                    add_filter( 'wp_default_editor', 'devvn_wp_default_editor' );
					$settings = array(
						'textarea_name'	=>	'pointdata[location][]',
						'tabindex' => 4,
					      	'tinymce' => array(
						        'min_height'	=>	200,
								'toolbar1'		=>	'bold,italic,underline,bullist,numlist,link,unlink,forecolor,undo,redo,wp_more',
					...
					wp_editor($pointLocation, 'point_location'.$countPoint, $settings);
					?>

					<h3 class="modal-title">Airport Name (Long Beach Airport)</h3>
					<?php
                    add_filter( 'wp_default_editor', 'devvn_wp_default_editor' );
					$settings = array(
						'textarea_name'	=>	'pointdata[airport][]',
						'tabindex' => 4,
					      	'tinymce' => array(
						        'min_height'	=>	200,
								'toolbar1'		=>	'bold,italic,underline,bullist,numlist,link,unlink,forecolor,undo,redo,wp_more',
					...
					wp_editor($airport, 'point_airport'.$countPoint, $settings);
					?>

					<h3 class="modal-title">Location (City, State)</h3>
					<?php
                    add_filter( 'wp_default_editor', 'devvn_wp_default_editor' );
					$settings = array(
						'textarea_name'	=>	'pointdata[location2][]',
						'tabindex' => 4,
					      	'tinymce' => array(
						        'min_height'	=>	200,
								'toolbar1'		=>	'bold,italic,underline,bullist,numlist,link,unlink,forecolor,undo,redo,wp_more',
					...
					wp_editor($pointLocation2, 'point_location2'.$countPoint, $settings);
					?>

                    <h3 class="modal-title">Aircrafts</h3>
					<?php
                    add_filter( 'wp_default_editor', 'devvn_wp_default_editor' );
					$settings = array(
						'textarea_name'	=>	'pointdata[aircrafts][]',
						'tabindex' => 4,
					      	'tinymce' => array(
						        'min_height'	=>	200,
								'toolbar1'		=>	'bold,italic,underline,bullist,numlist,link,unlink,forecolor,undo,redo,wp_more',
					...
					wp_editor($aircrafts, 'point_aircrafts'.$countPoint, $settings);
					?>
