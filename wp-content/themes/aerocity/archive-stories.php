...
<main id="main" class="page-main" role="main">
    ...
    <div class="stories-category__wrapper">
        <ul class="stories-category__nav">
            <li class="stories-category__item stories-category__item_active" data-post-filter="-1">ALL STORIES</li>
            ...
            if ( $count > 0 ) {
                for ($i = 0; $i <= 6; $i++) {
                    echo '<li class="stories-category__item" data-post-filter="' . $terms[$i]->term_id . '">' . $terms[$i]->name . '</li>';
                }
            } ?>
        </ul>
