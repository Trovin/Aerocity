<script>
    ...
    jQuery(function($) {
        ...
        function setPostType() {
            ...
            else if( $('body').hasClass('tax-stories-category') ) {
                postType = 'stories';
                itemClass = 'page-stories__item';
            }
        ...
        $('.category-select_container').on('change', 'select', function() {
            categoryId = $('.category-select_container').find('li.selected').data('value');
            flag = true;
            paged = 1;
            requestData();
        });
